...
export const categories: Category[] = [
  ...
  },
  {
    ...
    title: "Буровые и сваебойные",
    short: "Скважины и фундаменты",
    description:
      "Роторно-буровая техника и сваебойные установки для фундаментных и инфраструктурных проектов. Сопровождаем сделку от заявки до передачи техники.",
    image:
